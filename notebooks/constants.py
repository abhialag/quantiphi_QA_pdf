...
SOURCE_DIRECTORY = f"{ROOT_DIRECTORY}/SOURCE_DATA_DB"
SOURCE_DIR_FILE = f"{ROOT_DIRECTORY}/SOURCE_DATA_DB/ConceptsofBiology-WEB_Chapter 1-2.pdf"
SOURCE_DIR_FILE = f"../SOURCE_DATA_DB/ConceptsofBiology-WEB_Chapter 1-2.pdf" # remove this once running from scripts

PERSIST_DIRECTORY = f"{ROOT_DIRECTORY}/VECTOR_DBS"
